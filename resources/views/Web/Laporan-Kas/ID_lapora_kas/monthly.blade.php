...
@section('container')
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10 ml-3">
                                            <span class="h2 text-danger"><strong> Laporan Kas Bulanan
                                                </strong></span>
                    ...
                    <div class="card overflow-hidden">
                        ...
                        <div class="container bg-white p-3 mb-5" style="height: 100%;">
                            ...
                            <div class="table-responsive mt-4 mb-5 ">
                                @if (count($all_noted_monthly_CashStatement) !== 0)
                                    <table class="table  table-bordered table-sm">
                                        ...
                                        <tbody id="tbl_bulanan">
                                            @foreach ($all_noted_monthly_CashStatement as $buku)
                                ...
                                @else
                                    <p>Data Kosong</p>
                                @endif
                                {{ $all_noted_monthly_CashStatement->render() }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="text-center font-weight-bold">Statistik Grafik Finance Bulanan</h3>
                            <div class="pl-4 mb-5">
    ...
    <script>
        ...
        function filterRows() {
            ...
            var dateTo = dateFrom
            $('#tbl_bulanan tr').each(function(i, tr) {
