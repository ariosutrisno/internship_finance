...
@section('title', 'Laporan Kas Mingguan')
@section('container')
        ...
        <div class="page-wrapper">
            <div class="container-fluid">
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10 ml-3">
                                            <span class="h2 text-danger"><strong> Laporan Kas Mingguan -
                    ...
                    <div class="card overflow-hidden">
                                    ...
                                    <li class="nav-item d-none d-sm-block mr-1 mt-2">
                                        <select
                                            ...
                                            @if (count($all_book) !== 0)
                                                ...
                                                <option data-url="/cash-statement/weekly">Semua Kas</option>
                                                @foreach ($all_book as $item)
                                                    @if ($item->id_kas)
                                                        <option value="{{ $item->id_kas }}"
                                                            data-url="/cash-statement/{{ $item->id_kas }}/weekly">
                        ...
                        <div class="container bg-white p-3 mb-5" style="height: 100%;">
                            ...
                            <div class="table-responsive mt-4 mb-5 ">
                                @if (count($all_noted_weeklyID_CashStatement) !== 0)
                                    <table class="table  table-bordered table-sm">
                                        ...
                                        <tbody id="tbl_weekly">
                                            @foreach ($all_noted_weeklyID_CashStatement as $buku)
                                ...
                                @else
                                    <p>Data Kosong</p>
                                @endif
                                {{ $all_noted_weeklyID_CashStatement->render() }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="text-center font-weight-bold">Statistik Grafik Finance Mingguan</h3>
                            <div class="pl-4 mb-5">
    ...
    <script>
        ...
        function filterRows() {
            ...
            var dateTo = dateFrom
            $('#tbl_weekly tr').each(function(i, tr) {
