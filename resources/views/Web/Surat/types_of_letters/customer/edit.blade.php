                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('update_Customer', $customer->id_customer) }}" method="POST">
                                @csrf
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="nama">Nama</label>
                                        <input type="text" class="form-control" id="nama" placeholder="Nama"
                                            name="name_customer" value="{{ $customer->name_customer }}">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="email">Email</label>
                                        <input type="email" class="form-control" id="email" placeholder="email"
                                            name="email_customer" value="{{ $customer->email_customer }}">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea type="text" id="perusahaan" class="form-control" name="address_company_customer">{{ $customer->address_company_customer }}</textarea>
                                    </div>
                                </div>
