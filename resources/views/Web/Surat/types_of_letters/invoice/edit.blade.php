                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10 ml-3">
                                            ...
                                            <br><span>buat invoice dan berikan kepada orang lain</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
    ...
    <script>
        ...
        function coba() {
            ...
            for (var x = 1; x <= parseInt(term); x++) {
                $('.tambah').append(
                    ` <div class="form-group row dab"><label for="Term" class="col-sm-3   col-form-label">Term ke-` +
                    x +
                    `<span id="termin"></span></label><div class="col-sm-9"> <input type="text" readonly class="form-control" id="inputtermin" name="terminstandar[]" value="` +
                    total + `"></div></div>`);
            }
