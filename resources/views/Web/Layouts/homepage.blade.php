...
@section('container')
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p class="lead text-white"><strong> Hallo Selamat Datang Di Alan Finance!</strong></p>
                    <h1 class="display-4 text-white"><strong>Rencanakan Bisnis Anda.</strong> </h1>
                    <p class="text-white"> Menangai Pemasukan dan pengeluaran Keuangan Anda. Dan dapatkan segera Aplikasi
                        di bawah ini</p>
                    <p>
                        <a href=""><img src="frontend/img/app.png" style="max-width: 194px; max-height: 75px;"
                                class="mt-2" alt="nostrum"></a> <a href=""><img
                                src="frontend/img/en_badge_web_generic-1.png" class="mt-2" alt="nostrum">
                        </a>
                    </p>
                    <p class="lead mt-5">
                        @guest
                ...
                <div class="col-md-6">
                    <center>
                        <img class="text-center" src="frontend/img/asset-alanfintech-1.png"
                            style="max-height: 720px !important;" alt="#">
                    </center>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg">
                        <center>
                            ...
                            <img src="frontend/img/Groupwl@2x.png" style="min-height: 60px; min-width: 60px;"
                                alt="Test>.jpg"></img>
                    ...
                    <div class="col-lg">
                        <center>
                            <img src="frontend/img/Groupch@2x.png" style="min-height: 60px; min-width: 60px;"
                                alt="Test>.jpg"></img>
                        </center>
                    ...
                    <div class="col-lg">
                        <center>
                            <img src="frontend/img/Groupdl@2x.png" style="min-height: 60px; min-width: 60px;"
                                alt="Test>.jpg"></img>
                        </center>
                    ...
                    <div class="col-lg">
                        <center>
                            <img src="frontend/img/Groupact@2x.png   " style="min-height: 60px; min-width: 60px;"
                                alt="Test>.jpg"></img>
                        </center>
            ...
            <div class="row mt-5 ">
                ...
                <div class="col-lg-6">
                    <div class="konten">
                        ...
                        <a href=""><img src="frontend/img/app.png" style="max-width: 194px; max-height: 75px;"
                                class="mt-2" alt="nostrum"></a> <a href=""><img
                                src="frontend/img/en_badge_web_generic-1.png" class="mt-2" alt="nostrum"></a>
    ...
    <div class="container-fluid bg-light">
        ...
        <div class="row" style="padding-right: 10%; padding-left: 10%;">
            ...
            <div class="col-lg-4  mt-5 pb-5">
                <center><img src="frontend/img/asset-alanfintech.png" alt="" srcset=""></center>
            </div>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto pt-5 ">
                <center><img src="frontend/img/pin@2x.png" alt="">
    ...
    <div class="container-fluid bb h-100">
        ...
        <div class="row">
            <div class="col-lg-6">
                <img src="frontend/img/man-standing-on-stage-1.png"
                    style="margin-top:50px;max-height: 400px; max-width: 720px;" alt="" srcset="">
            </div>
                ...
                <center>
                    ...
                    <div class="col-md-12 py-5 justify-content-center">
                        <div class="mb-5 flex-center justify-content-center">
                            ...
                            <!-- Facebook -->
                            <a href="" class="fb-ic">
                                <img src="frontend/img/facebook.png" class="jejer" alt="">
                            </a>
                            <!-- Twitter -->
                            <a href="" class="tw-ic">
                                <img src="frontend/img/instagram.png" class="jejer" alt="">
                            </a>

                            <!--Instagram-->
                            <a href="" class="ins-ic">
                                <img src="frontend/img/logo.png" class="jejer" alt="">
                            </a>

                            <!--Instagram-->
                            <a href="" class="ins-ic">
                                <img src="frontend/img/mail.png" class="jejer" alt="">
                            </a>
                            <!--Pinterest-->
                            <!-- Twitter -->
                            <a class="tw-ic">
                                <img src="frontend/img/twitter.png" class="jejer" alt="">
                            </a>
                        </div>
