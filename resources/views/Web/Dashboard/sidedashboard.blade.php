            ...
            <ul class="navbar-nav float-right navbar-right ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                        ...
                        @if (!$id->img_users)
                            <img src="{{ asset('frontend/imgNew/blank_profile.png') }}" alt="user"
                                class="rounded-circle" width="40" height="40" />
                        @else
                            <img src="{{ asset('storage/storage/' . $id->img_users) }}" alt="user"
                                class="rounded-circle" width="40" height="40" />
                        @endif
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        <li class="sidebar-item">
                            <a href="{{ route('index_Debt') }}" class="sidebar-link"><span class="hide-menu">
                                    Hutang
                                </span></a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{ route('index_AccountsReceivable') }}" class="sidebar-link"><span
                                    class="hide-menu">
                                    Piutang
                                </span></a>
                        </li>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i
                            data-feather="file-text" class="feather-icon text-white"></i><span
                            class="hide-menu">Laporan
                            Kas
                        </span></a>
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        <li class="sidebar-item">
                            <a href="{{ route('daily_CashStatement') }}" class="sidebar-link"><span
                                    class="hide-menu"> Laporan Kas
                                </span></a>
                        </li>
                    </ul>
                    <!-- End Laporan Kas -->
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        ...
                        {{-- <li class="sidebar-item">
                            <a href="{{ url('/pengaturan-multiUser') }}" class="sidebar-link"><span
                                    class="hide-menu">
                                    Multi User
                                </span></a>
                        </li> --}}
